 ...
 */
final class Version20191223181250 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ad ADD user_id INT DEFAULT NULL, ADD category_id INT DEFAULT NULL, CHANGE photo photo VARCHAR(128) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ad DROP user_id, DROP category_id, CHANGE photo photo VARCHAR(128) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
    }
}
